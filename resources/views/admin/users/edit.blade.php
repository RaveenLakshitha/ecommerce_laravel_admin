        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Profile Modification</h1>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Updating administrative record for <span class="text-indigo-600 dark:text-indigo-400 font-bold uppercase tracking-tighter">{{ $user->name }}</span></p>
                </div>
            </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div class="space-y-1.5">
                                    <label for="phone"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Contact Number <span
                                            class="text-red-500">*</span></label>
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-5">
                                <p class="text-xs text-gray-500 dark:text-gray-400 italic">Leave password fields blank if rotation is not required.</p>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div class="space-y-1.5 relative">
                                        <label for="password"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">New Password</label>
                                        <div class="relative">
                                            <input type="password" name="password" id="password" minlength="8"
                                                class="block w-full rounded-xl border-gray-200 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a30 px-4 py-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm">
                                            <button type="button" onclick="togglePassword('password', 'eyePassword')" class="absolute inset-y-0 right-4 flex items-center text-gray-400">
                                    ...
                                    <div class="space-y-1.5 relative">
                                        <label for="password_confirmation"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Confirm Rotation</label>
                                        <div class="relative">
                                            <input type="password" name="password_confirmation" id="password_confirmation"
                                                class="block w-full rounded-xl border-gray-200 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a30 px-4 py-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm">
                                            <button type="button" onclick="togglePassword('password_confirmation', 'eyeConfirm')" class="absolute inset-y-0 right-4 flex items-center text-gray-400">
                                    ...
                                    @foreach($roles as $role)
                                        <label class="relative flex items-center p-4 rounded-2xl border border-gray-100 dark:border-surface-tonal-a30 hover:bg-indigo-50/50 dark:hover:bg-indigo-950/10 cursor-pointer transition group">
                                            ...
                                            <div class="ml-4">
                                                ...
                                                <p class="text-[10px] text-gray-400 font-medium italic underline decoration-indigo-500/20 underline-offset-2">Active Privileges</p>
                                            </div>
                                        </label>
                                    @endforeach
                                </div>
