                                ...
                                <div class="p-2.5 space-y-1">
                                    @foreach($tabs as $key => $label)
                                        <button type="button" onclick="switchTab('{{ $key }}')" id="sidebar-{{ $key }}"
                                            class="sidebar-link w-full text-left px-4 py-3 rounded-xl text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white transition-all flex items-center gap-3">
