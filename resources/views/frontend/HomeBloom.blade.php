...
@section('content')
    ...
    <style>
        ...
        .p-card-bloom:hover .p-img-wrap img {
        ...
        .p-card-bloom:hover .p-quick-btn {
        ...
        .col-card-bloom:hover .col-bg-bloom {
            transform: scale(1.05);
        }
        ...
        .col-card-bloom:hover .col-cta-bloom {
            opacity: 1;
            transform: translateY(0);
        }
        ...
        .nl-bloom-eyebrow::before,
        .nl-bloom-eyebrow::after {
            content: '';
            width: 24px;
            height: 1px;
        ...
        .nl-bloom-form input::placeholder {
            color: var(--taupe);
        }
    ...
    <section class="hero" id="hero">
        ...
        <div class="hero-image-col">
            <img class="hero-img-main" src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&q=80"
                alt="New season fashion" id="heroMainImg">
                    ...
                    <div class="p-card-bloom bloom-up">
                        ...
                        <div class="p-info-bloom">
                            ...
                            <div class="p-swatches-bloom">
                                @foreach($p['colors'] as $c)<span class="p-dot-swatch"
                                style="background:{{ $c }};"></span>@endforeach
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="editorial-inner">
            <div class="editorial-text bloom-up">
                ...
                <p class="editorial-body">
                    Every piece in our collection is thoughtfully designed and ethically crafted. We believe that beautiful
                    clothing should feel as good as it looks — for you and the planet.
                </p>
            ...
            <div class="editorial-img-grid bloom-scale">
                <div class="ed-img">
                    <img src="https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=600&q=80" alt="Editorial 1"
                        loading="lazy">
                </div>
                <div class="ed-img">
                    <img src="https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?w=400&q=80" alt="Editorial 2"
                        loading="lazy">
                </div>
                <div class="ed-img">
                    <img src="https://images.unsplash.com/photo-1496747611176-843222e1e57c?w=400&q=80" alt="Editorial 3"
                        loading="lazy">
                </div>
            </div>
        </div>
    ...
    <section class="collections-bloom">
        <div class="sec-inner">
            <div class="sec-head bloom-up">
                ...
                <a href="#" class="sec-all-link">Browse all <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
