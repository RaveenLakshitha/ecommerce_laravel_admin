    ...
    <div id="filter-panel" class="absolute inset-y-0 right-0 w-full md:max-w-lg bg-white dark:bg-surface-tonal-a20 shadow-2xl transform translate-x-full transition-transform duration-500 ease-in-out flex flex-col">
        <div class="flex items-center justify-between px-8 py-4 border-b border-gray-100 dark:border-white/5">
            <div>
                ...
                <p class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mt-1">Refine your search criteria</p>
            </div>
        ...
        <div class="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar">
            <div class="space-y-6">
                <div>
                    <label class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">System Role</label>
                ...
                <div>
                    <label class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Account Lifecycle</label>
                ...
                <div class="pt-6 border-t border-gray-100 dark:border-white/5">
                    <p class="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-4">Provisioning Window</p>
