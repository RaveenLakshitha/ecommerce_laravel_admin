<form action="{{ $location ? route('shipping.pickups.update', $location->id) : route('shipping.pickups.store') }}"
    method="POST" id="pickup-drawer-form" class="space-y-6">
    @csrf
    @if($location)
        @method('PUT')
    @endif
        ...
        <div class="pt-4 border-t border-gray-100 dark:border-white/5 space-y-4">
            ...
            <div>
                ...
                <input type="text" name="address_line_1"
                    value="{{ old('address_line_1', $location ? $location->address_line_1 : '') }}" required
            ...
            <div>
                ...
                <input type="text" name="address_line_2"
                    value="{{ old('address_line_2', $location ? $location->address_line_2 : '') }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="postal_code"
                        value="{{ old('postal_code', $location ? $location->postal_code : '') }}"
            ...
            <label
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">
                        {{ __('file.Active operational status') }}</h3>
    ...
    <div class="flex gap-3 pt-6 border-t border-gray-100 dark:border-white/5">
        ...
        <button type="submit"
            ...
            <span
                id="pickup-drawer-save-text">{{ $location ? __('file.save_changes') : __('file.save_pickup_location') ?? 'Save Pickup Location' }}</span>
            <div id="pickup-drawer-loader"
