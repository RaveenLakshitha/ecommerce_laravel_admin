...
@section('title', 'Discount Rules & Flash Sales')

@section('content')
    <div class="px-4 sm:px-6 lg:px-8 pb-4 sm:py-12 pt-20">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 dark:text-primary-a0">Discount Rules</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Set up automatic discounts, flash sales, and
                    special offers (BOGO).</p>
            </div>
            <div>
        ...
        <div id="bulk-delete-form" class="hidden mb-6">
            <form method="POST" action="{{ route('discount-rules.bulkDelete') }}" id="bulk-delete-form-el"
                ...
                <span class="text-sm font-medium text-red-800 dark:text-red-300">
                    <span id="selected-count">0</span> rules selected
                </span>
                <button type="submit"
            ...
            document.addEventListener('DOMContentLoaded', function () {
                const table = $('#application-table').DataTable({
                    ...
                    language: {
                        ...
                        emptyTable: "No discount rules found matching your criteria.",
                        processing: false,
                    },
                    autoWidth: false,
                    scrollX: false
                ...
                window.confirmDelete = function (url) {
                    if (!confirm('Are you sure you want to delete this specific rule?')) return;
