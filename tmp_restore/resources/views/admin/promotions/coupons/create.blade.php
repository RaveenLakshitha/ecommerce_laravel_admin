            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    <a href="{{ route('coupons.index') }}"
                        ...
                        Back to Coupons</a>
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create Coupon</h1>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Define a new promotional code for your
                        storefront.</p>
                </div>
            </div>
