...
<div class="admin-page animate-fade-in-up">
    <div class="admin-page-inner">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Add Variant to: {{ $product->name }}</h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create a new specific version of this product (e.g., Red, Large).</p>
            </div>
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="text" name="sku" id="sku" value="{{ old('sku') }}" placeholder="e.g. PRD-RED-LG" required 
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" step="0.01" name="price" id="price" value="{{ old('price', $product->base_price) }}" required 
                    ...
                    <div class="bg-white dark:bg-surface-tonal-a20 rounded-lg shadow-sm border border-gray-200 dark:border-surface-tonal-a30 overflow-hidden">
                        ...
                        <div class="p-4 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="dimensions" id="dimensions" value="{{ old('dimensions') }}" placeholder="e.g. 10x20x5 cm" 
                                    class="block w-full rounded-md border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-surface-tonal-a20 px-3 py-2 text-xs font-bold shadow-sm text-black dark:text-white outline-none transition-all focus:bg-white dark:focus:bg-surface-tonal-a30 focus:border-indigo-300 dark:focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/5 focus:shadow-md">
                            </div>
                            <div class="pt-2">
