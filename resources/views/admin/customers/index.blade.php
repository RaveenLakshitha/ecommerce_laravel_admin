        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const table = $('#application-table').DataTable({
                    ...
                    language: {
                        search: "",
                        searchPlaceholder: "{{ __('file.search_customers') ?? "Search Customers..." }}",
                        lengthMenu: "{{ __('file.dt_length_menu') ?? "_MENU_" }}",
                        info: "{{ __('file.showing_customers') ?? "Showing _START_ to _END_ of _TOTAL_ Customers" }}",
                        infoEmpty: "{{ __('file.no_customers_found') ?? "No customers found" }}",
                        emptyTable: "{{ __('file.no_customers_found') ?? "No customers found" }}",
