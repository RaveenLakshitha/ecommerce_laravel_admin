    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div>
            <button @click="openCreateModal()"
                ...
                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
            ...
            <table id="application-table" class="w-full divide-y divide-gray-200 dark:divide-surface-tonal-a30 nowrap" style="width:100%">
                <thead class="bg-gray-50 dark:bg-surface-tonal-a10 border-b border-gray-200 dark:border-surface-tonal-a30">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider all">Location Name</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider all">Address</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">Contact</th>
            ...
            <div class="inline-block w-full max-w-xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-surface-tonal-a10 rounded-2xl shadow-xl border border-gray-200 dark:border-surface-tonal-a30"
                ...
                <form :action="formUrl" method="POST">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-surface-tonal-a30 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white" x-text="isEditing ? 'Edit Pickup Location' : 'Add Pickup Location'"></h3>
                    ...
                    <div class="px-6 py-6 space-y-4">
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Location Name <span class="text-red-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Address Line 1 <span class="text-red-500">*</span></label>
                                <input type="text" name="address_line_1" x-model="form.address_line_1" required placeholder="Street address"
                                    class="block w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20 text-sm focus:ring-indigo-500">
                            </div>
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Address Line 2</label>
                                <input type="text" name="address_line_2" x-model="form.address_line_2" placeholder="Suite, floor, etc."
                                    class="block w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20 text-sm focus:ring-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-semibold">
                            <div class="sm:col-span-2 space-y-1 text-sm font-medium">
                                <label class="block text-gray-700 dark:text-gray-300">City <span class="text-red-500">*</span></label>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-surface-tonal-a10 border-t border-gray-200 dark:border-surface-tonal-a30 flex gap-3">
                        ...
                        <button type="submit" class="flex-1 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg transition hover:bg-indigo-700">Save Location</button>
                    </div>
                </form>
            </div>
        </div>
