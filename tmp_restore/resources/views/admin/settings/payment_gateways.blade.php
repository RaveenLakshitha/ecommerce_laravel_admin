            ...
            <div class="mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 animate-fade-in-up">
                <div>
                    <h1
                        ...
                        Financial Nexus</h1>
                    <p
                        class="mt-6 text-sm text-gray-400 dark:text-gray-500 font-medium italic underline decoration-indigo-500/10 underline-offset-4">
                        ...
                        <div
                            ...
                            @if($setting->is_active)
                                <div
                                    ...
                                    <span
                                        class="text-[9px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest italic">Nexus
                                        Active</span>
                                </div>
                            @else
                                <div
                                    ...
                                    <span
                                        class="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest italic">Offline</span>
                                </div>
                            @endif
                        </div>
                            ...
                            <form action="{{ route('settings.payment-gateways.update', $gw) }}" method="POST" class="space-y-8">
                                ...
                                @if(!in_array($gw, ['cod', 'bank']))
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div class="space-y-3">
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Simulation
                                        ...
                                        @if($gw === 'payhere')
                                            <div class="space-y-3">
                                                <label
                                                    class="block text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Corp-ID
                                                    (Merchant)</label>
                                        ...
                                        <div class="md:col-span-2 space-y-3">
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Public
                                        ...
                                        <div class="md:col-span-2 space-y-3">
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Root
                                ...
                                @else
                                    <div class="space-y-3">
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest italic">Execution
                                            Instructions</label>
