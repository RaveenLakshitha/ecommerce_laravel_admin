        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Onboard Delivery
                        Partner</h1>
                    <p
                        ...
                        Register new logistics providers and configure their operational API parameters.</p>
                </div>
            </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    class="text-[10px] font-black text-amber-500 bg-amber-500/10 px-2 py-0.5 rounded border border-amber-500/20 uppercase tracking-widest">Protocol
                                    Required</span>
                            </div>
