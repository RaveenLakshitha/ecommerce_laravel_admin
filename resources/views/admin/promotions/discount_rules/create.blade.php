...
@section('title', __('file.add_new_discount_rule'))
            ...
            <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        {{ __('file.add_new_discount_rule') }}</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('file.create_discount_rule_helper') }}
                    </p>
                </div>
                <div class="flex items-center gap-3">
                    <button type="submit" form="create-rule-form"
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-1">
                                    <div>
                                        <label
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">{{ __('file.rule_type') }}
                                            <span class="text-red-500">*</span></label>
                                        <select name="type" x-model="ruleType" required
                                            ...
                                            <option value="bogo">{{ __('file.bogo_buy_one_get_one') }}</option>
                                            <option value="buy_x_get_y">{{ __('file.buy_x_get_y_custom') }}</option>
                                        </select>
                                    </div>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                <div id="no-banners-msg"
                                    class="py-12 text-center border-2 border-dashed border-gray-100 dark:border-surface-tonal-a30 rounded-2xl bg-gray-50/10">
                                    <div
                                    ...
                                    <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest">
                                        {{ __('file.promotional_banners_helper') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-4 space-y-6">
                                <div class="space-y-3">
                                    <label
                                        ...
                                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }}
                                            class="mt-1 h-4 w-4 rounded border-gray-300 dark:border-surface-tonal-a30 text-green-500 focus:ring-green-500 transition-all">
                                        <div class="ml-3">
                                            <h3
                                    ...
                                    <label
                                        ...
                                        <input type="checkbox" name="is_flash_sale" id="is_flash_sale" value="1" {{ old('is_flash_sale') ? 'checked' : '' }}
                                            class="mt-1 h-4 w-4 rounded border-gray-300 dark:border-surface-tonal-a30 text-purple-500 focus:ring-purple-500 transition-all">
                                        <div class="ml-3">
                                            <h3
                                                class="text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="0" name="priority" id="priority"
                                        ...
                                        class="block w-full rounded-md border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-surface-tonal-a20 px-3 py-2 text-xs font-bold shadow-sm text-indigo-600 dark:text-indigo-400 outline-none transition-all focus:bg-white dark:focus:bg-surface-tonal-a30 focus:border-indigo-300 dark:focus:border-indigo-500/50 focus:ring-2 focus:ring-indigo-500/5 focus:shadow-md">
                                    <p
                                        class="text-[10px] text-gray-400 dark:text-gray-500 mt-1 uppercase tracking-widest font-bold">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="datetime-local" name="starts_at" id="starts_at"
                                            value="{{ old('starts_at') }}"
                                            class="block w-full rounded-md border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-surface-tonal-a20 px-3 py-2 text-xs font-bold shadow-sm text-gray-700 dark:text-gray-300 outline-none transition-all focus:bg-white dark:focus:bg-surface-tonal-a30">
                                    </div>
                                    <div>
                                        <label for="expires_at"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">{{ __('file.ends_at') }}</label>
                ...
                row.innerHTML = `
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        <div class="md:col-span-2">
                            <label class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">{{ __('file.banner_image') }}</label>
