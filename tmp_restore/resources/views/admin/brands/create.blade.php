        ...
        <div class="admin-page-inner">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <h1 class="admin-page-title">Add New Brand</h1>
                    <p class="admin-page-subtitle">Register a new manufacturer or brand for your catalog.</p>
                </div>
            </div>
                            ...
                            <div class="admin-card-body space-y-5">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input type="url" name="website_url" id="website_url" value="{{ old('website_url') }}"
                                            placeholder="https://example.com" class="fi">
                                        @error('website_url') <p class="fi-error">{{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label for="sort_order" class="fi-label">Sort Order</label>
                                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', 0) }}" class="fi">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                        placeholder="Brief brand story or overview…" class="fi">{{ old('description') }}</textarea>
                            ...
                            <div class="admin-card-body space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}"
                                        placeholder="SEO Title for search results" class="fi">
                                </div>
                                <div>
                                    <label for="meta_description" class="fi-label">Meta Description</label>
                                    <textarea name="meta_description" id="meta_description" rows="3"
                                        placeholder="Brief summary for search engine snippets…" class="fi">{{ old('meta_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="admin-card-body space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="aspect-square admin-upload-zone"
                                        ...
                                        <img id="logo-preview" src="" class="absolute inset-0 w-full h-full object-contain p-4 hidden">
                                        <div id="logo-placeholder" class="admin-upload-placeholder">
                                ...
                                <div class="pt-2 flex flex-col gap-3">
                                    <button type="submit" class="admin-btn-primary">Create Brand</button>
