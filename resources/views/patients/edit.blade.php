                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.address_ph') }}">{{ old('address', $patient->address) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="phone" value="{{ old('phone', $patient->phone) }}" minlength="7" maxlength="15"
                                    class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                            ...
                            <div>
                                ...
                                <input type="text" name="alternative_phone"
                                    value="{{ old('alternative_phone', $patient->alternative_phone) }}" minlength="7" maxlength="15"
                                    class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                    placeholder="+1234567890">
                        ...
                        <div>
                            ...
                            <select name="preferred_contact_method"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                <option value="phone" {{ old('preferred_contact_method', $patient->preferred_contact_method) == 'phone' ? 'selected' : '' }}>
                                    {{ __('file.phone') }}
                                </option>
                                <option value="email" {{ old('preferred_contact_method', $patient->preferred_contact_method) == 'email' ? 'selected' : '' }}>
                                    {{ __('file.email') }}
                                </option>
                                <option value="sms" {{ old('preferred_contact_method', $patient->preferred_contact_method) == 'sms' ? 'selected' : '' }}>{{ __('file.sms') }}
                                </option>
                            </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_phone"
                                        value="{{ old('emergency_contact_phone', $patient->emergency_contact_phone) }}" minlength="7" maxlength="15"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                        placeholder="+1234567890">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            @if($patient->document)
                                ...
                                @endphp
                                <div class="mb-4">
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-2">{{ __('file.view_current_document') }}</p>
                                    @if(in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp']))
                                        <div class="bg-gray-50 dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-gray-700 inline-block">
                                            <img src="{{ $docUrl }}" class="rounded shadow-sm object-contain" alt="Current Document" style="max-height: 200px;">
                                        </div>
                                    @elseif($extension === 'pdf')
                                        <div class="w-full md:w-2/3">
                                            <iframe src="{{ $docUrl }}" class="w-full rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm" style="height: 300px;"></iframe>
                                        </div>
                                    @else
                                        <a href="{{ $docUrl }}" target="_blank" class="inline-flex items-center text-sm text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                                            </svg>
                                            {{ __('file.view_current_document') }} (Download)
                                        </a>
                                    @endif
                                </div>
                            @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="height_cm" value="{{ old('height_cm', $patient->height_cm) }}"
                                    min="50" max="250"
                                    class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                    placeholder="170">
                            ...
                            <div>
                                ...
                                <input type="number" name="weight_kg" value="{{ old('weight_kg', $patient->weight_kg) }}"
                        ...
                        <div>
                            ...
                            <textarea name="allergies" rows="3"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.allergies_ph') }}">
                        ...
                        <div>
                            ...
                            <textarea name="current_medications" rows="3"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.medications_ph') }}">
                        ...
                        <div>
                            ...
                            <textarea name="chronic_conditions" rows="3"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.conditions_ph') }}">
                        ...
                        <div>
                            ...
                            <textarea name="past_surgeries" rows="4"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.surgeries_ph') }}">
                        ...
                        <div>
                            ...
                            <textarea name="previous_hospitalizations" rows="4"
                                class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow resize-none"
                                placeholder="{{ __('file.hospitalizations_ph') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select name="smoking_status"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                        <option value="never" {{ old('smoking_status', $patient->smoking_status) == 'never' ? 'selected' : '' }}>
                                            {{ __('file.never') }}
                                        </option>
                                        <option value="former" {{ old('smoking_status', $patient->smoking_status) == 'former' ? 'selected' : '' }}>
                                            {{ __('file.former') }}
                                        </option>
                                        <option value="current" {{ old('smoking_status', $patient->smoking_status) == 'current' ? 'selected' : '' }}>
                                            {{ __('file.current') }}
                                        </option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="alcohol_consumption"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                        <option value="none" {{ old('alcohol_consumption', $patient->alcohol_consumption) == 'none' ? 'selected' : '' }}>
                                            {{ __('file.none') }}
                                        </option>
                                        <option value="occasional" {{ old('alcohol_consumption', $patient->alcohol_consumption) == 'occasional' ? 'selected' : '' }}>
                                            {{ __('file.occasional') }}
                                        </option>
                                        <option value="moderate" {{ old('alcohol_consumption', $patient->alcohol_consumption) == 'moderate' ? 'selected' : '' }}>
                                            {{ __('file.moderate') }}
                                        </option>
                                        <option value="heavy" {{ old('alcohol_consumption', $patient->alcohol_consumption) == 'heavy' ? 'selected' : '' }}>
                                            {{ __('file.heavy') }}
                                        </option>
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    ...
                                    <select name="exercise_frequency"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                        <option value="never" {{ old('exercise_frequency', $patient->exercise_frequency) == 'never' ? 'selected' : '' }}>
                                            {{ __('file.never') }}
                                        </option>
                                        <option value="rarely" {{ old('exercise_frequency', $patient->exercise_frequency) == 'rarely' ? 'selected' : '' }}>
                                            {{ __('file.rarely') }}
                                        </option>
                                        <option value="weekly" {{ old('exercise_frequency', $patient->exercise_frequency) == 'weekly' ? 'selected' : '' }}>
                                            {{ __('file.weekly') }}
                                        </option>
                                        <option value="daily" {{ old('exercise_frequency', $patient->exercise_frequency) == 'daily' ? 'selected' : '' }}>
                                            {{ __('file.daily') }}
                                        </option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dietary_habits"
                                        value="{{ old('dietary_habits', $patient->dietary_habits) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                        ...
                        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="primary_insurance_provider"
                                        value="{{ old('primary_insurance_provider', $patient->primary_insurance_provider) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="primary_group_number"
                                        value="{{ old('primary_group_number', $patient->primary_group_number) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                        placeholder="GRP987">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_policy_holder_name"
                                        value="{{ old('primary_policy_holder_name', $patient->primary_policy_holder_name) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                        placeholder="{{ __('file.full_name_ph') }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="primary_relationship_to_patient"
                                        value="{{ old('primary_relationship_to_patient', $patient->primary_relationship_to_patient) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                        placeholder="{{ __('file.relationship_ph') }}">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="primary_insurance_phone"
                                        value="{{ old('primary_insurance_phone', $patient->primary_insurance_phone) }}" minlength="7" maxlength="15"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="secondary_insurance_provider"
                                        value="{{ old('secondary_insurance_provider', $patient->secondary_insurance_provider) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                                        placeholder="{{ __('file.insurance_company') }}">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="secondary_policy_number"
                                        value="{{ old('secondary_policy_number', $patient->secondary_policy_number) }}"
                                        class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow"
                        ...
                        <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div>
                                ...
                                <select name="preferred_billing_method"
                                    class="w-full px-2 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-gray-900 dark:text-white transition-shadow">
                                    <option value="insurance_first" {{ old('preferred_billing_method', $patient->preferred_billing_method) == 'insurance_first' ? 'selected' : '' }}>
                                        {{ __('file.insurance_first') }}
                                    </option>
                                    <option value="self_pay" {{ old('preferred_billing_method', $patient->preferred_billing_method) == 'self_pay' ? 'selected' : '' }}>
                                        {{ __('file.self_pay') }}
                                    </option>
                                </select>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <label class="flex items-center">
                                        <input type="checkbox" name="payment_methods[]" value="credit_card" {{ in_array('credit_card', $selected) ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center">
                                        <input type="checkbox" name="payment_methods[]" value="debit_card" {{ in_array('debit_card', $selected) ? 'checked' : '' }}
                                            class="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded dark:bg-transparent dark:border-gray-600">
                                        <span
                                            class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ __('file.debit_card') }}</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="payment_methods[]" value="cash" {{ in_array('cash', $selected) ? 'checked' : '' }}
                                            class="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded dark:bg-transparent dark:border-gray-600">
                                        <span
                                            class="ml-2 text-sm text-gray-700 dark:text-gray-300">{{ __('file.cash') }}</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="checkbox" name="payment_methods[]" value="bank_transfer" {{ in_array('bank_transfer', $selected) ? 'checked' : '' }}
                                            class="h-4 w-4 text-gray-900 focus:ring-gray-900 border-gray-300 rounded dark:bg-transparent dark:border-gray-600">
                                        <span
