        ...
        <div class="admin-page-inner">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Modify properties for: <span
                            class="font-semibold text-gray-900 dark:text-white">{{ $collection->name }}</span></p>
                </div>
            </div>
                        ...
                        <div class="admin-card">
                            ...
                            <div class="admin-card-body space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4" placeholder="Brief description…"
                                        class="fi">{{ old('description', $collection->description) }}</textarea>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="aspect-[16/9] admin-upload-zone"
                                        ...
                                        <div id="banner-placeholder"
                                            class="admin-upload-placeholder {{ $collection->banner_url ? 'hidden' : '' }}">
                                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
