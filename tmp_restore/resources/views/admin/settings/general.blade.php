    ...
    <div class="px-4 sm:px-6 lg:px-8 pb-4 sm:py-12 pt-20 transition-all duration-300">
        <div class="max-w-5xl mx-auto">
            ...
            <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data"
                class="animate-fade-in-scale space-y-12">
                @csrf
                ...
                <div
                    ...
                    <div class="p-8 space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-3">
                                <label
                                    class="block text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('file.site_name') }}
                                ...
                                @error('site_name') <p
                                    class="text-[10px] font-black text-rose-500 uppercase tracking-widest mt-1 italic">
                                {{ $message }}</p> @enderror
                            </div>
                            <div class="space-y-3">
                                <label
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="space-y-3" x-data="{
                                ...
                                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1.5">
                                    Preview: <span class="font-bold text-gray-700 dark:text-gray-300"
                                        x-text="selectedCurrency.symbol + ' 1,234.00'"></span>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="flex flex-col gap-6">
                                    ...
                                    <div class="relative group/upload">
                                        ...
                                        <div
                                            ...
                                            <svg class="w-5 h-5 text-gray-400 group-hover/upload:text-indigo-500 transition-colors"
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-6">
                                        ...
                                        <div class="flex flex-col gap-2">
                                            <input type="text" id="color_hex_display"
                                            ...
                                            <span
                                                class="text-[9px] font-black text-gray-400 uppercase tracking-widest italic">Chromatic
                                                ID</span>
                                        </div>
                                    </div>
                                    <p
                                        class="text-[11px] font-bold text-gray-400 leading-relaxed italic border-l-2 border-indigo-500/20 pl-4">
