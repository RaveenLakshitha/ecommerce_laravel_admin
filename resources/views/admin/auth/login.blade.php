<x-admin-guest-layout>
    ...
    <div class="lg:hidden flex flex-col items-center mb-8 text-center pt-8">
        <div class="w-16 h-16 bg-slate-100 rounded-2xl flex items-center justify-center p-3 shadow-md mb-4 text-slate-800">
            @if($site_logo ?? false)
                <img src="{{ $site_logo }}" alt="{{ $site_name ?? __('messages.Admin Portal') }} Logo" class="w-12 h-12 object-contain">
            @else
