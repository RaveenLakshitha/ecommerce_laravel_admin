        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Updating settings for <span
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-5">
                                <div class="space-y-1.5">
                                    <label for="code"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Coupon Code
                                ...
                                <div class="space-y-1.5">
                                    <label for="description"
                                        class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Internal
                                        Description</label>
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div class="space-y-1.5">
                                    <label for="max_discount_amount"
                                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Maximum
                                        Discount Cap (Optional)</label>
                                    <div class="relative">
                                        <span
                                            class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 dark:text-gray-500 text-sm font-bold pointer-events-none">$</span>
                                    ...
                                    <p class="text-[10px] text-gray-400 font-medium italic">Only applicable for percentage
                                        discounts.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    ...
                                    <div class="space-y-1.5">
                                        <label for="applies_to"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Apply
                                        ...
                                        <select name="applies_to" id="applies_to" required
                                            ...
                                            <option value="specific_products" {{ old('applies_to', $coupon->applies_to) == 'specific_products' ? 'selected' : '' }}>Specific
                                                Products</option>
                                            <option value="specific_categories" {{ old('applies_to', $coupon->applies_to) == 'specific_categories' ? 'selected' : '' }}>Specific
                                                Categories</option>
                                            <option value="specific_collections" {{ old('applies_to', $coupon->applies_to) == 'specific_collections' ? 'selected' : '' }}>Specific
                                                Collections</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="hidden space-y-3" id="products_container">
                                    <label
                                        class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest">Select
                                        Restricted Products</label>
                                    <select name="product_ids[]" id="product_ids" multiple
                                        class="block w-full rounded-xl border-gray-200 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a30 p-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-all h-40 custom-scrollbar">
                                ...
                                <div
                                    ...
                                    <div class="space-y-1.5">
                                        <label for="usage_limit"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Global
                                            Usage Limit</label>
                                    ...
                                    <div class="space-y-1.5">
                                        <label for="usage_per_user"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Usage Limit
                                            Per User</label>
                        ...
                        <div
                            ...
                            <div class="p-6">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div class="space-y-1.5">
                                        <label for="starts_at"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Starts
                                            At</label>
                                    ...
                                    <div class="space-y-1.5">
                                        <label for="expires_at"
                                            class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Expires
                                            At</label>
