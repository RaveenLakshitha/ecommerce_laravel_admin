                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-surface-tonal-a30">
                                    @forelse($recentOrders as $order)
                                        <tr class="hover:bg-gray-100/50 dark:hover:bg-surface-tonal-a20/50 transition-colors">
                                            <td class="px-6 py-4">
                        ...
                        <div
                            ...
                            <div class="divide-y divide-gray-50 dark:divide-surface-tonal-a30">
                                @forelse($lowStockAlerts as $variant)
                                    <div
                                        class="px-6 py-4 flex items-center justify-between gap-4 hover:bg-gray-100/50 dark:hover:bg-surface-tonal-a30/50 transition-colors group">
