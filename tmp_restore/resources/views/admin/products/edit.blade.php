        ...
        <div class="admin-page-inner">
            ...
            <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Updating: <span
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        <label for="name"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Product
                                            Name</label>
                                    ...
                                    <div>
                                        <label for="slug"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Slug</label>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                    <div>
                                        <label for="base_price"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Base
                                            Price</label>
                                        <div class="relative">
                                            <span
                                                class="absolute inset-y-0 left-4 flex items-center text-gray-400 font-black text-xs pointer-events-none">$</span>
                                        ...
                                        @error('base_price') <p class="text-[10px] text-red-500 mt-1 font-bold px-1">
                                        {{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label for="sale_price"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Sale
                                            Price</label>
                                        <div class="relative">
                                            <span
                                                class="absolute inset-y-0 left-4 flex items-center text-gray-400 font-black text-xs pointer-events-none">$</span>
                                        ...
                                        @error('sale_price') <p class="text-[10px] text-red-500 mt-1 font-bold px-1">
                                        {{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label for="brand_id"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Brand</label>
                                        <div class="relative">
                                        ...
                                        @error('brand_id') <p class="text-[10px] text-red-500 mt-1 font-bold px-1">
                                        {{ $message }}</p> @enderror
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    <label for="short_description"
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Short
                                        Description</label>
                                ...
                                <div>
                                    <label for="description"
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Full
                                        Story</label>
                                ...
                                <div>
                                    <label for="fabric_details"
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Fabric
                                        Details</label>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                <div class="space-y-4" x-data="{
                                    ...
                                    <div
                                        class="max-h-[220px] overflow-y-auto pr-2 custom-scrollbar grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <template x-for="category in filtered" :key="category.id">
                                            <label
                                                class="flex items-center p-3 rounded-xl border border-gray-100 dark:border-surface-tonal-a30 hover:bg-gray-50 dark:hover:bg-surface-tonal-a30 transition cursor-pointer group">
                                                ...
                                                <span
                                                    class="text-xs font-bold text-gray-600 dark:text-gray-400 ml-3 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"
                                                    x-text="category.name"></span>
                                            </label>
                                        </template>
                                    </div>
                                    <template
                                        x-for="item in categories.filter(c => c.checked && !filtered.find(f => f.id === c.id))"
                                        :key="'hidden-'+item.id">
                                        <input type="hidden" name="categories[]" :value="item.id">
                                    </template>
                                </div>
                                @error('categories') <p class="text-xs text-red-500 mt-2 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    class="text-[10px] font-bold text-indigo-500 uppercase tracking-widest leading-none">Manage
                                    Media</span>
                            </div>
                            <div class="p-4">
                                <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 gap-4" id="media-grid">
                                    @foreach($product->images as $image)
                                        <div class="aspect-square rounded-xl border border-gray-100 dark:border-surface-tonal-a30 overflow-hidden relative group bg-gray-50 dark:bg-surface-tonal-a30/20"
                                            ...
                                            @if($image->is_primary)
                                                <div
                                                    class="absolute top-2 left-2 px-2 py-0.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-[8px] font-bold rounded uppercase tracking-widest">
                                                    Primary</div>
                                            @endif
                                            <div
                                    ...
                                    <label
                                        class="aspect-square admin-upload-zone rounded-xl border-dashed border-2 border-gray-200 dark:border-surface-tonal-a30 bg-gray-100/50 dark:bg-surface-tonal-a30/20 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-indigo-400 transition-all">
                                        <svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 4v16m8-8H4" />
                                        </svg>
                                        <p class="text-[8px] font-black text-gray-400 uppercase tracking-widest">Add Media
                                        </p>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a href="{{ route('products.variants.create', $product->id) }}"
                                    class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all shadow-lg shadow-indigo-600/20 active:scale-[0.98]">
                                    + Add Variant
                                </a>
                            </div>
                                ...
                                <table class="w-full text-left border-collapse">
                                    <thead>
                                        <tr
                                            ...
                                            <th
                                                class="px-6 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                SKU</th>
                                            <th
                                                class="px-6 py-3 text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                Attributes</th>
                                    ...
                                    <tbody class="divide-y divide-gray-50 dark:divide-surface-tonal-a30">
                                        @forelse($product->variants as $variant)
                                            <tr
                                                class="hover:bg-gray-50 dark:hover:bg-surface-tonal-a30 transition-colors group">
                                                <td class="px-6 py-3.5">
                                                    <div class="flex flex-col">
                                                        <span
                                                            class="text-sm font-bold text-gray-700 dark:text-white">{{ $variant->sku }}</span>
                                                        @if($variant->is_default)
                                                            <span
                                                                class="text-[8px] font-black text-indigo-500 uppercase tracking-tighter">Default</span>
                                                        @endif
                                                    </div>
                                                </td>
                                                <td class="px-6 py-3.5">
                                                    <div class="flex flex-wrap gap-1">
                                                        @foreach($variant->attributeValues as $value)
                                                            <span
                                                                class="px-2 py-0.5 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-[10px] font-bold border border-indigo-100 dark:border-indigo-500/20">
                                                ...
                                                <td class="px-6 py-3.5 text-center">
                                                    <span
                                                        class="text-xs font-bold {{ $variant->isInStock() ? 'text-emerald-500' : 'text-red-500' }}">
                                                ...
                                                <td class="px-6 py-3.5 text-right">
                                                    <div class="flex flex-col items-end">
                                                        <span
                                                            class="text-sm font-bold text-gray-900 dark:text-white">${{ number_format($variant->price, 2) }}</span>
                                                        @if($variant->sale_price)
                                                            <span
                                                                class="text-[10px] text-emerald-500 font-bold">${{ number_format($variant->sale_price, 2) }}</span>
                                                        @endif
                                                    </div>
                                                </td>
                                                <td class="px-6 py-3.5">
                                                    <div
                                                        ...
                                                        <a href="{{ route('products.variants.edit', [$product->id, $variant->id]) }}"
                                                            class="p-1.5 rounded-lg text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition-all">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5"
                                                    class="px-6 py-10 text-center text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                                    No variants defined</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                    ...
                    <div class="xl:col-span-1 space-y-4">
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Meta
                                        Title</label>
                                ...
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Canonical
                                        URL</label>
                            ...
                            <div class="p-4 space-y-4">
                                <div class="space-y-2">
                                    <label
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-xs font-bold text-gray-900 dark:text-white leading-none">Store
                                                Visibility</h3>
                                            <p class="text-[10px] text-gray-500 dark:text-gray-400 font-medium mt-1">
