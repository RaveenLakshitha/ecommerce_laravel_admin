                ...
                const table = $('#application-table').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: (data) => data ? `<code class="px-2 py-0.5 rounded bg-gray-100 dark:bg-surface-tonal-a30 text-[11px] font-mono text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-surface-tonal-a10">${data}</code>` : `<span class="text-[11px] text-gray-400 italic">{{ __('file.no_tracking') }}</span>`
                        },
