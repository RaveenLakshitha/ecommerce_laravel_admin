            ...
            <table id="application-table" class="w-full divide-y divide-gray-200 dark:divide-surface-tonal-a30 nowrap" style="width:100%">
                <thead class="bg-gray-50 dark:bg-surface-tonal-a10 border-b border-gray-200 dark:border-surface-tonal-a30">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider all">Rate Name</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider all">Zone</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">Amount</th>
                        <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider desktop">Conditions</th>
            ...
            <div class="inline-block w-full max-w-2xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-surface-tonal-a10 rounded-2xl shadow-xl border border-gray-200 dark:border-surface-tonal-a30"
                ...
                <form :action="formUrl" method="POST">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-surface-tonal-a30 flex justify-between items-center">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white" x-text="isEditing ? 'Edit Shipping Rate' : 'Add Shipping Rate'"></h3>
                    ...
                    <div class="px-6 py-6 space-y-5">
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Rate Name <span class="text-red-500">*</span></label>
                            <input type="text" name="name" x-model="form.name" required placeholder="e.g. Standard Shipping"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shipping Zone <span class="text-red-500">*</span></label>
                        ...
                        <div class="space-y-1">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Rate Amount (Rs.) <span class="text-red-500">*</span></label>
                        ...
                        <div class="pt-4 border-t border-gray-100 dark:border-surface-tonal-a30">
                            <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-3">Conditions (Optional)</h4>
                            <div class="grid grid-cols-2 gap-4 text-xs">
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-gray-500 mb-1">Min Weight (kg)</label>
                                        <input type="number" step="0.01" name="min_weight" x-model="form.min_weight" class="w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 mb-1">Max Weight (kg)</label>
                                        <input type="number" step="0.01" name="max_weight" x-model="form.max_weight" class="w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20">
                                    </div>
                                </div>
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-gray-500 mb-1">Min Order Price (Rs.)</label>
                                        <input type="number" step="0.01" name="min_price" x-model="form.min_price" class="w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20">
                                    </div>
                                    <div>
                                        <label class="block text-gray-500 mb-1">Max Order Price (Rs.)</label>
                                        <input type="number" step="0.01" name="max_price" x-model="form.max_price" class="w-full rounded-lg border-gray-300 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a20">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl border border-emerald-100 dark:border-emerald-800/30">
                            <label class="block text-sm font-bold text-emerald-800 dark:text-emerald-400 mb-1">Free Shipping Threshold (Rs.)</label>
                            <input type="number" step="0.01" name="free_shipping_threshold" x-model="form.free_shipping_threshold" placeholder="Value for free shipping"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label for="is_active" class="text-sm font-medium text-gray-700 dark:text-gray-300 text-sm">Active</label>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-surface-tonal-a10 border-t border-gray-200 dark:border-surface-tonal-a30 flex gap-3">
                        ...
                        <button type="submit" class="flex-1 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg transition hover:bg-indigo-700">Save Rate</button>
                    </div>
                </form>
            </div>
        </div>
