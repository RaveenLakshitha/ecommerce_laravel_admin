...
@section('title', $store_name ?? 'Karbnzol — Premium Menswear')
...
<section class="hero" id="heroSection">
    <div class="hero-track" id="heroTrack">
        ...
        @php $slides = [
            ['tag'=>'SS 2025 — New Drop','l1'=>'WEAR','l2'=>'THE','l3'=>'EDGE.','sub'=>'Precision-cut menswear engineered for the modern man. Sharp lines, premium fabrics, uncompromising quality.','img'=>'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1600&q=80'],
            ['tag'=>'New Arrivals','l1'=>'DEFINE','l2'=>'YOUR','l3'=>'STYLE.','sub'=>'From boardroom to weekend — our latest drop covers every dimension of the contemporary wardrobe.','img'=>'https://images.unsplash.com/photo-1516826957135-700dedea698c?w=1600&q=80'],
            ['tag'=>'Activewear Collection','l1'=>'PUSH','l2'=>'YOUR','l3'=>'LIMITS.','sub'=>'High-performance activewear built for intensity. Style that doesn\'t stop when you do.','img'=>'https://images.unsplash.com/photo-1571945153237-4929e783af4a?w=1600&q=80'],
        ]; @endphp

        @foreach($slides as $i => $sl)
        <div class="hero-slide {{ $i === 0 ? 'active' : '' }}">
            <div class="slide-bg" style="background-image: url('{{ $sl['img'] }}');"></div>
            <div class="slide-progress"></div>
            <div class="hero-content">
                <p class="slide-eyebrow">{{ $sl['tag'] }}</p>
                <h1 class="slide-title">
                    {{ $sl['l1'] }}
                    <span class="stroke">{{ $sl['l2'] }}</span>
                    <span class="gold">{{ $sl['l3'] }}</span>
                </h1>
...
<div class="marquee-bar" aria-hidden="true">
    <div class="marquee-track">
        @php $mw = ['Free Island Delivery','New Arrivals Weekly','MintPay Available','Premium Quality','Sri Lanka\'s Best','Free Island Delivery','New Arrivals Weekly','MintPay Available','Premium Quality','Sri Lanka\'s Best','Free Island Delivery','New Arrivals Weekly','MintPay Available','Premium Quality','Sri Lanka\'s Best']; @endphp
        @foreach($mw as $w)
        ...
        <div class="collections-grid">
            ...
            <div class="col-card reveal">
                ...
                <div class="col-content">
                    ...
                    <a href="{{ route('collections.show', $c['slug']) }}" class="col-arrow" aria-label="Shop {{ $c['name'] }}">
