...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 pb-4 sm:py-12 pt-20">
        ...
        <div id="bulk-delete-form" class="hidden mb-6">
            <form method="POST" action="{{ route('suppliers.bulkDelete') }}" id="bulk-delete-form-el"
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                $('#bulk-delete-form-el').on('submit', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: (response) => {
                            table.draw(false);
                            $('.row-checkbox').prop('checked', false); // Clear individual checkboxes
                            $('#select-all').prop('checked', false);
                            updateBulkDelete();
                            if (typeof showNotification === 'function') showNotification('Success', response.message || 'Suppliers deleted successfully.', 'success');
                        },
                        error: (xhr) => {
