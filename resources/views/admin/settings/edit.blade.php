    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <x-input label="Clinic Name" name="site_name" :value="old('site_name', $setting->site_name)" />
                <x-input label="Store ID/Registration Number" name="site_id" :value="old('site_id', $setting->site_id)" />
