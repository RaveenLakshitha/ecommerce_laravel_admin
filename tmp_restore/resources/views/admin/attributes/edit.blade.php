        ...
        <div class="admin-page-inner">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Modify properties and values for: <span
                            class="font-semibold text-gray-900 dark:text-white">{{ $attribute->name }}</span></p>
                </div>
            </div>
                            ...
                            <div class="admin-card-body space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{ old('slug', $attribute->slug) }}"
                                        required class="fi" style="font-family: 'DM Mono', monospace;">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="sort_order" id="sort_order"
                                        value="{{ old('sort_order', $attribute->sort_order) }}" required min="0" class="fi">
                                </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="border-b border-gray-100 dark:border-surface-tonal-a30">
                                        ...
                                        @endif
                                        <th
                                            class="px-6 py-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider text-center">
                                            Order</th>
                                        <th
                                ...
                                <tbody class="divide-y divide-gray-50 dark:divide-surface-tonal-a30">
                                    @forelse($attribute->values as $value)
                                        <tr
                                            class="hover:bg-gray-100/50 dark:hover:bg-surface-tonal-a30/10 transition-colors group">
                                            <td class="px-6 py-4">
                                                <span
                                                    class="text-sm font-medium text-gray-900 dark:text-white">{{ $value->value }}</span>
                                            </td>
                                            <td class="px-6 py-4">
                                                <span
                                                    class="text-xs font-mono text-gray-400 dark:text-gray-500">{{ $value->slug }}</span>
                                            </td>
                                            @if($attribute->type === 'color_swatch')
                                                <td class="px-6 py-4">
                                                    <div class="flex items-center gap-2">
                                                        <div class="w-6 h-6 rounded-lg border border-gray-200 dark:border-surface-tonal-a30 shadow-sm"
                                            ...
                                            <td class="px-6 py-4 text-center">
                                                <span
                                                    class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $value->sort_order }}</span>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <form
                                                    action="{{ route('attributes.values.destroy', [$attribute->id, $value->id]) }}"
                                                    method="POST" onsubmit="return confirm('Delete this value?');">
                                                    @csrf @method('DELETE')
                                                    <button type="submit"
                                                        class="p-1.5 rounded-lg text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all opacity-0 group-hover:opacity-100">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="px-6 py-16 text-center">
                                                <div
                                                    class="mx-auto w-12 h-12 bg-gray-50 dark:bg-surface-tonal-a30 rounded-full flex items-center justify-center text-gray-400 mb-3">
                                                ...
                                                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Add values below to
                                                    make this attribute usable.</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                    <div>
                                        ...
                                        <input type="text" name="value" id="val_value" required
                                            placeholder="Red, XL, Leather..." class="fi">
                                    </div>
                                    <div>
                                        <label for="val_slug" class="fi-label fi-label-required">Slug</label>
                                        <input type="text" name="slug" id="val_slug" required placeholder="auto-generated"
                                            class="fi" style="font-family: 'DM Mono', monospace;">
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <input type="color" id="color_picker"
                                                    class="w-10 h-[38px] rounded-lg border border-gray-200 dark:border-surface-tonal-a30 p-0 cursor-pointer shrink-0"
