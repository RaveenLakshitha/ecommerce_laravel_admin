...
@section('content')
            ...
            <div class="flex items-center gap-3">
                <button type="button" id="filter-button"
                    ...
                    <span id="filter-count"
                        class="hidden ml-1 px-1.5 py-0.5 text-[10px] rounded-full bg-indigo-600 text-white font-bold"></span>
                </button>
            </div>
        </div>
    ...
    <div id="filter-drawer" class="fixed inset-0 z-[100] hidden overflow-hidden transition-all duration-500">
        ...
        <div id="filter-panel"
            class="absolute inset-y-0 right-0 w-full md:max-w-sm bg-white dark:bg-surface-tonal-a10 shadow-2xl transform translate-x-full transition-transform duration-500 ease-in-out flex flex-col">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-surface-tonal-a20">
                <div>
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white uppercase tracking-tight">Commerce Filters
                    </h3>
            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-6">
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Financial
                            Status</label>
            ...
            <div
                class="px-6 py-4 bg-gray-50 dark:bg-surface-tonal-a10 border-t border-gray-200 dark:border-surface-tonal-a20 flex gap-3">
