                            ...
                            <div class="admin-card-body space-y-5">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                        placeholder="Brief description of this collection…" class="fi">{{ old('description') }}</textarea>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-1">
                                    <div>
                                        ...
                                        <input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="fi">
                                        @error('start_date') <p class="fi-error">{{ $message }}</p> @enderror
                                    </div>
                                    <div>
                                        <label for="end_date" class="fi-label">End Date</label>
                                        <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="fi">
                            ...
                            <div class="admin-card-body space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="aspect-[16/9] admin-upload-zone"
                                        ...
                                        <img id="banner-preview" src="" class="absolute inset-0 w-full h-full object-cover hidden z-10">
