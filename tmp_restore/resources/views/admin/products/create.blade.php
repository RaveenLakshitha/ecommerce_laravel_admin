                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Description</label>
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                @error('images') <p class="text-[10px] text-red-500 mt-2 font-bold">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="lg:col-span-1 space-y-4">
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                <div>
                                    <label
                                        class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">Category</label>
                                    <div class="relative">
