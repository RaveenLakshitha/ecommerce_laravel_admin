...
@section('title', __('file.create_medicine_template'))
    ...
    <div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
        <div class=" mb-8">
            <div class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-3">
                ...
                <span class="text-gray-900 dark:text-white">{{ __('file.create_template') }}</span>
            </div>
            <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">{{ __('file.create_new_medicine_template') }}
            </h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ __('file.medicine_template_description') }}
            </p>
        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                ...
                                placeholder="{{ __('file.description_placeholder') }}">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div id="medications-container" class="space-y-4"
                            ...
                            <div
                                ...
                                <div class="md:col-span-3">
                                    ...
                                    <select name="medications[0][inventory_item_id]" required
                                    ...
                                    <input type="hidden" name="medications[0][name]" class="hidden-name">
                                    @error('medications.0.inventory_item_id')
                                        <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select name="medications[0][route]"
                                        ...
                                        @foreach($routes as $value => $label)
                                            <option value="{{ $value }}" {{ old("medications.0.route") == $value ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="md:col-span-12">
                                    ...
                                    <textarea name="medications[0][instructions]" rows="2"
