...
@push('styles')
    <style>
        ...
        * {
        ...
        .dark .tgl input:checked~.tgl-track {
            background: #e5e7eb;
        }

        .dark .tgl input:checked~.tgl-track::after {
            background: #111827;
        }
...
@section('content')
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-16">
            ...
            @if(session('success'))
                <div
                    class="mb-6 flex items-center gap-3 bg-white dark:bg-gray-900 border border-emerald-200 dark:border-emerald-800/40 rounded-xl px-4 py-3 text-sm text-emerald-700 dark:text-emerald-400 shadow-sm">
            ...
            @if($errors->any())
                <div
                    class="mb-6 bg-white dark:bg-gray-900 border border-red-200 dark:border-red-800/40 rounded-xl px-4 py-3 shadow-sm">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 order-2 lg:order-1">
                        <div class="sticky top-24 space-y-6">
                            ...
                            {{-- Save / Discard --}}
                            <div
                                class="bg-white dark:bg-surface-tonal-a20 rounded-2xl border border-gray-200 dark:border-surface-tonal-a30 shadow-sm overflow-hidden animate-fade-in-up">
                                <div
                                    class="px-5 py-4 border-b border-gray-100 dark:border-surface-tonal-a30 bg-gray-100/50 dark:bg-surface-tonal-a10/30">
                                    <p
                            ...
                            {{-- Section Quick-Nav --}}
                            <div
                                class="bg-white dark:bg-surface-tonal-a20 rounded-2xl border border-gray-200 dark:border-surface-tonal-a30 shadow-sm overflow-hidden animate-fade-in-up delay-100">
                    ...
                    <div class="lg:col-span-2 order-1 lg:order-2">
                        ...
                        <div class="tab-panel" id="panel-general">
                            <div
                                class="bg-white dark:bg-surface-tonal-a20 rounded-2xl border border-gray-200 dark:border-surface-tonal-a30 shadow-sm overflow-hidden">
                                ...
                                <div class="p-6 space-y-5">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            ...
                                            @error('site_name')<p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div>
                                            <label for="site_title"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Site
                                                Title Tag</label>
                                            <input type="text" name="site_title" id="site_title"
                                                value="{{ old('site_title', $setting->site_title) }}"
                                                placeholder="Trendy Fashion for Everyone" class="fi">
                                            @error('site_title')<p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <label for="site_description"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Short
                                            Description</label>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label for="contact_email"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Contact
                                                Email <span class="text-red-500">*</span></label>
                                            <input type="email" name="contact_email" id="contact_email"
                                                value="{{ old('contact_email', $setting->contact_email) }}"
                                                placeholder="hello@store.com" class="fi">
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="contact_phone" id="contact_phone"
                                                ...
                                                placeholder="+1 555-0123" class="fi">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="address"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Address
                                            <span class="text-red-500">*</span></label>
                                        <textarea name="address" id="address" rows="2" placeholder="Street, Building, Suite"
                                            class="fi resize-none">{{ old('address', $setting->address) }}</textarea>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label for="city"
                                        ...
                                        <div>
                                            <label for="state"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">State
                                                / Province</label>
                                            <input type="text" name="state" id="state"
                                                value="{{ old('state', $setting->state) }}" placeholder="NY" class="fi">
                                        </div>
                                        <div>
                                            <label for="country"
                                        ...
                                        <div>
                                            <label for="postal_code"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Postal
                                                / Zip Code</label>
                                            <input type="text" name="postal_code" id="postal_code"
                                                value="{{ old('postal_code', $setting->postal_code) }}" placeholder="10001"
                                                class="fi">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 space-y-5">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            ...
                                            @error('currency')<p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div>
                                            <label for="currency_symbol"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Currency
                                                Symbol</label>
                                            <input type="text" name="currency_symbol" id="currency_symbol"
                                                value="{{ old('currency_symbol', $setting->currency_symbol) }}"
                                                placeholder="$, Rs., £" class="fi">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label for="currency_position"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Symbol
                                                Position</label>
                                        ...
                                        <div>
                                            <label for="number_of_decimals"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Decimal
                                                Points</label>
                                            <input type="number" name="number_of_decimals" id="number_of_decimals"
                                                value="{{ old('number_of_decimals', $setting->number_of_decimals ?? 2) }}"
                                                placeholder="2" min="0" max="4" class="fi">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            ...
                                            <input type="text" name="decimal_separator" id="decimal_separator"
                                                value="{{ old('decimal_separator', $setting->decimal_separator ?? '.') }}"
                                                maxlength="1" class="fi">
                                        </div>
                                        <div>
                                            <label for="thousands_separator"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Thousands
                                                Separator</label>
                                            <input type="text" name="thousands_separator" id="thousands_separator"
                                                value="{{ old('thousands_separator', $setting->thousands_separator ?? ',') }}"
                                                maxlength="1" class="fi">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 space-y-5">
                                    <div>
                                        <label for="meta_title"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Global
                                            Meta Title</label>
                                        <input type="text" name="meta_title" id="meta_title"
                                            value="{{ old('meta_title', $setting->meta_title) }}"
                                            placeholder="My Store – Trendy Fashion Online" class="fi">
                                    </div>
                                    <div>
                                        ...
                                        <textarea name="meta_description" id="meta_description" rows="3"
                                            placeholder="What users will see in Google search."
                                            class="fi resize-none">{{ old('meta_description', $setting->meta_description) }}</textarea>
                                    </div>
                                    <div>
                                        <label for="meta_keywords"
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Meta
                                            Keywords</label>
                                        <input type="text" name="meta_keywords" id="meta_keywords"
                                            value="{{ old('meta_keywords', $setting->meta_keywords) }}"
                                            placeholder="clothing, fashion, online store" class="fi">
                                    </div>
                                    <div>
                                        <p
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900 dark:text-white">Enable Global
                                                Shipping</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Toggle shipping
                                                features across the entire store.</p>
                                        </div>
                                        <label class="tgl">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label for="default_shipping_method"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Default
                                                Shipping Method</label>
                                            <input type="text" name="default_shipping_method" id="default_shipping_method"
                                                value="{{ old('default_shipping_method', $setting->default_shipping_method) }}"
                                                placeholder="Standard Delivery" class="fi">
                                        </div>
                                        <div>
                                            <label for="estimated_delivery_days"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Est.
                                                Delivery Time</label>
                                            <input type="text" name="estimated_delivery_days" id="estimated_delivery_days"
                                                value="{{ old('estimated_delivery_days', $setting->estimated_delivery_days) }}"
                                                placeholder="3-5 Business Days" class="fi">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                        <div>
                                            <label for="free_shipping_threshold"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Free
                                                Shipping Over</label>
                                            <div class="relative">
                                                <span
                                                    class="absolute inset-y-0 left-3.5 flex items-center text-xs font-semibold text-gray-500 dark:text-gray-400 pointer-events-none">{{ $setting->currency_symbol }}</span>
                                                <input type="number" name="free_shipping_threshold"
                                                    id="free_shipping_threshold"
                                                    value="{{ old('free_shipping_threshold', $setting->free_shipping_threshold) }}"
                                                    step="0.01" class="fi pl-7">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="shipping_cost_per_order"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Rate
                                                Per Order</label>
                                            <div class="relative">
                                                <span
                                                    class="absolute inset-y-0 left-3.5 flex items-center text-xs font-semibold text-gray-500 dark:text-gray-400 pointer-events-none">{{ $setting->currency_symbol }}</span>
                                                <input type="number" name="shipping_cost_per_order"
                                                    id="shipping_cost_per_order"
                                                    value="{{ old('shipping_cost_per_order', $setting->shipping_cost_per_order) }}"
                                                    step="0.01" class="fi pl-7">
                                            </div>
                                        </div>
                                        <div>
                                            <label for="shipping_cost_per_item"
                                                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Rate
                                                Per Item</label>
                                            <div class="relative">
                                                <span
                                                    class="absolute inset-y-0 left-3.5 flex items-center text-xs font-semibold text-gray-500 dark:text-gray-400 pointer-events-none">{{ $setting->currency_symbol }}</span>
                                                <input type="number" name="shipping_cost_per_item"
                                                    id="shipping_cost_per_item"
                                                    value="{{ old('shipping_cost_per_item', $setting->shipping_cost_per_item) }}"
                                                    step="0.01" class="fi pl-7">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <p class="text-sm font-semibold text-gray-900 dark:text-white">Enable Tax
                                                Calculations</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Enable or disable
                                                VAT/GST across the store.</p>
                                        </div>
                                        <label class="tgl">
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <label class="ck-card">
                                                <input type="checkbox" name="cash_on_delivery_enabled" value="1"
                                                    class="w-4 h-4 rounded border-gray-300 text-gray-900 shrink-0 mt-0.5 cursor-pointer"
                                                    {{ $setting->cash_on_delivery_enabled ? 'checked' : '' }}>
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900 dark:text-white">Cash on
                                                        Delivery</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Enable COD
                                                        for local orders</p>
                                                </div>
                                            </label>
                                            <label class="ck-card">
                                                <input type="checkbox" name="bank_transfer_enabled" value="1"
                                                    class="w-4 h-4 rounded border-gray-300 text-gray-900 shrink-0 mt-0.5 cursor-pointer"
                                                    {{ $setting->bank_transfer_enabled ? 'checked' : '' }}>
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900 dark:text-white">Bank
                                                        Transfer</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Enable direct
                                                        bank deposit</p>
                                                </div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <label class="ck-card">
                                                <input type="checkbox" name="guest_checkout_enabled" value="1"
                                                    class="w-4 h-4 rounded border-gray-300 text-gray-900 shrink-0 mt-0.5 cursor-pointer"
                                                    {{ $setting->guest_checkout_enabled ? 'checked' : '' }}>
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900 dark:text-white">Guest
                                                        Checkout</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Allow orders
                                                        without accounts</p>
                                                </div>
                                            </label>
                                            <label class="ck-card">
                                                <input type="checkbox" name="require_account_for_checkout" value="1"
                                                    class="w-4 h-4 rounded border-gray-300 text-gray-900 shrink-0 mt-0.5 cursor-pointer"
                                                    {{ $setting->require_account_for_checkout ? 'checked' : '' }}>
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900 dark:text-white">Require
                                                        Account</p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Mandatory
                                                        registration at checkout</p>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label
                                                class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Low
                                                Stock Threshold</label>
                                            <input type="number" name="low_stock_threshold"
                                                value="{{ old('low_stock_threshold', $setting->low_stock_threshold) }}"
                                                class="fi" placeholder="5">
                                        </div>
                                        <div>
                                            <label
                                                class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Order
                                                Prefix</label>
                                            <input type="text" name="order_prefix"
                                                value="{{ old('order_prefix', $setting->order_prefix) }}" class="fi"
                                                placeholder="ORD-">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <label class="ck-card">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900 dark:text-white">Allow
                                                    Backorders</p>
                                                <p class="text-xs text-gray-500 mt-1">Enable customers to purchase
                                                    out-of-stock items</p>
                                            </div>
                                        </label>
                                        <div>
                                            <label
                                                class="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2">Out
                                                of Stock Behavior</label>
                                            <select name="out_of_stock_behavior" class="fi">
                                                <option value="hide" @selected($setting->out_of_stock_behavior == 'hide')>Hide
                                                    from store</option>
                                                <option value="show" @selected($setting->out_of_stock_behavior == 'show')>Show
                                                    with message</option>
                                                <option value="allow_backorder"
                                                    @selected($setting->out_of_stock_behavior == 'allow_backorder')>Allow
                                                    Backorder</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <label class="ck-card">
                                            <input type="checkbox" name="color_swatches_enabled" value="1" class="w-4 h-4"
                                                {{ $setting->color_swatches_enabled ? 'checked' : '' }}>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900 dark:text-white">Visual Color
                                                    Swatches</p>
                                                <p class="text-xs text-gray-500 mt-1">Show colors as swatches instead of
                                                    text</p>
                                            </div>
                                        </label>
                                    </div>
                                    <div
                                        class="grid grid-cols-1 sm:grid-cols-3 gap-5 border-t border-gray-50 dark:border-surface-tonal-a30 pt-6">
                                        <label class="ck-card">
                            ...
                            <div
                                ...
                                <div class="p-6 space-y-4">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Instagram
                                                URL</label>
                                            <input type="text" name="instagram_url"
                                                value="{{ old('instagram_url', $setting->instagram_url) }}"
                                                class="fi font-mono" placeholder="https://instagram.com/store">
                                        </div>
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Facebook
                                                URL</label>
                                            <input type="text" name="facebook_url"
                                                value="{{ old('facebook_url', $setting->facebook_url) }}"
                                                class="fi font-mono" placeholder="https://facebook.com/store">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="p-6 space-y-4">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Google
                                                Analytics ID</label>
                                            <input type="text" name="google_analytics_id"
                                                value="{{ old('google_analytics_id', $setting->google_analytics_id) }}"
                                                class="fi" placeholder="G-XXXXXXXXXX">
                                        </div>
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Facebook
                                            ...
                                            <input type="text" name="facebook_pixel_id"
                                                ...
                                                class="fi" placeholder="ID123456789">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="p-6 space-y-6">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">From
                                                Name</label>
                                            <input type="text" name="mail_from_name"
                                                value="{{ old('mail_from_name', $setting->mail_from_name) }}" class="fi">
                                        </div>
                                        <div>
                                            <label
                                                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">From
                        ...
                        <div class="tab-panel" id="panel-maintenance">
                            <div
                                ...
                                <div class="p-6 space-y-5">
                                    ...
                                    <div>
                                        <label
                                            class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5">Maintenance
                                            Message</label>
                                        <textarea name="maintenance_message" rows="3"
                                            class="fi resize-none">{{ old('maintenance_message', $setting->maintenance_message) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
