    ...
    <div class="admin-page animate-fade-in-up">
        <div class="admin-page-inner">
            ...
            <nav class="admin-breadcrumb mt-6" aria-label="Breadcrumb">
                ...
                <span class="active">{{ __('file.subscribers') }}</span>
            </nav>

            <div class="admin-page-header">
                <div>
                    <h1 class="admin-page-title">{{ __('file.subscribers') }}</h1>
                    <p class="admin-page-subtitle">{{ __('file.manage_subscribers') }}</p>
                </div>
            </div>
                ...
                const table = $('#application-table').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: data => `<span class="text-sm font-bold text-gray-900 dark:text-white leading-tight">${data}</span>`
                        },
                        {
                            data: 'name', name: 'first_name',
                            render: data => `<span class="text-sm font-medium text-gray-600 dark:text-gray-400">${data || '—'}</span>`
                        },
                        {
                            data: 'source', name: 'source',
                            render: data => `<span class="admin-badge admin-badge-neutral text-[10px] font-bold uppercase tracking-wider">${data || 'Organic'}</span>`
                        },
