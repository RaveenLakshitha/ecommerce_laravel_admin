                ...
                <div>
                    <nav class="flex items-center gap-2 mb-4 group/nav">
                        <a href="{{ route('categories.index') }}"
                            class="text-[10px] font-black text-gray-400 uppercase tracking-widest hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Taxonomy
                            Grid</a>
                        ...
                        <span
                            class="text-[10px] font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-widest italic">Recursive
                            Tree Analytics</span>
                    </nav>
                    <h1
                        ...
                        Hierarchy Visualization</h1>
                    <p class="mt-4 text-sm text-gray-500 dark:text-gray-400 font-medium italic">Tracing the structural
                        lineage and generational nesting of product classifications.</p>
                </div>
                    ...
                    <ul class="space-y-6">
                            ...
                            <li class="relative">
                                ...
                                <div class="flex items-center group/root transition-all hover:translate-x-1">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="text-[9px] font-black text-gray-400 uppercase tracking-widest mt-0.5">Primary
                                            Logic Node</span>
                                    </div>
                                    @if(!$category->is_active)
                                        <span
                                            class="ml-4 px-3 py-1 rounded-full text-[9px] font-black bg-gray-100 text-gray-400 dark:bg-surface-tonal-a30 dark:text-gray-500 border border-gray-200 dark:border-surface-tonal-a40">DECOMMISSIONED</span>
                                    @endif
                                    <div class="ml-auto opacity-0 group-hover/root:opacity-100 transition-opacity">
                                        <a href="{{ route('categories.edit', $category) }}"
                                            class="text-[9px] font-black text-indigo-500 uppercase tracking-widest hover:underline">Calibrate</a>
                                    </div>
                                </div>
                                            ...
                                            <li class="relative">
                                                <div
                                                    ...
                                                    <div class="flex flex-col">
                                                        ...
                                                        <span
                                                            class="text-[9px] font-bold text-gray-400 uppercase tracking-widest italic leading-none">Sub-Classification</span>
                                                    </div>
                                                    @if(!$child->is_active)
                                                        <span
                                                            class="ml-3 px-2 py-0.5 rounded-full text-[8px] font-black bg-gray-50 text-gray-300 dark:bg-surface-tonal-a30 dark:text-gray-600">INACTIVE</span>
                                                    @endif
                                                </div>
                        ...
                        @empty
                            <div class="text-center py-20 animate-fade-in-up">
                                ...
                                <p class="text-[11px] font-black text-gray-400 uppercase tracking-[0.2em]">Zero Trace Integrity
                                </p>
                                <p class="text-xs text-gray-400 dark:text-gray-500 mt-2 italic font-medium">No taxonomic
                                    definitions discovered in the system architecture.</p>
                            </div>
                        @endforelse
                    </ul>
                </div>
