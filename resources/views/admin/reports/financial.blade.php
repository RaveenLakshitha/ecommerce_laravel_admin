                    ...
                    <div class="admin-card p-6">
                        ...
                        <div class="space-y-3">
                            @forelse($ordersByStatus as $s)
                                ...
                                <div
                                    class="flex items-center justify-between p-3 rounded-xl bg-gray-100/50 dark:bg-surface-tonal-a30/50 border border-gray-100 dark:border-surface-tonal-a30">
