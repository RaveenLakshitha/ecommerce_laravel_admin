<section class="space-y-10">
    <header>
        <h2 class="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-[0.2em] mb-2">Security
            Recalibration</h2>
        <p class="text-sm font-black text-gray-900 dark:text-white uppercase tracking-tighter italic">Ensure your
            account remains secure by rotating your access credentials regularly.</p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-8">
        ...
        <div
            ...
            <label
                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Current Password') }}</label>
        ...
        <div
            class="space-y-3 p-6 bg-gray-100/50 dark:bg-surface-tonal-a10/50 rounded-3xl border border-gray-100 dark:border-surface-tonal-a30 shadow-inner">
            <label
                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('New Password') }}</label>
        ...
        <div
            class="space-y-3 p-6 bg-gray-100/50 dark:bg-surface-tonal-a10/50 rounded-3xl border border-gray-100 dark:border-surface-tonal-a30 shadow-inner">
            <label
                class="block text-[10px] font-black text-gray-400 uppercase tracking-widest">{{ __('Confirm Password') }}</label>
        ...
        <div class="flex items-center gap-6 pt-4">
            <button type="submit"
                ...
                Rotate Credentials
                <svg class="w-4 h-4 ml-2 transition-transform group-hover:rotate-45" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
