        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Define a new promotional code for your storefront.</p>
                </div>
            </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <select name="applies_to" id="applies_to" required
                                            ...
                                            <option value="specific_collections" {{ old('applies_to') == 'specific_collections' ? 'selected' : '' }}>Specific Collections</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="hidden space-y-3" id="collections_container">
                                    ...
                                    <select name="collection_ids[]" id="collection_ids" multiple class="block w-full rounded-xl border-gray-200 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a30 p-2 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 transition-all h-40 custom-scrollbar">
                                        @foreach($collections as $collection)
                                            <option value="{{ $collection->id }}" {{ (is_array(old('collection_ids')) && in_array($collection->id, old('collection_ids'))) ? 'selected' : '' }}>{{ $collection->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
