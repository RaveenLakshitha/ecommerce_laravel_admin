        ...
        <div class="admin-page-inner">
            ...
            <div class="admin-page-header">
                <div>
                    ...
                    <p class="admin-page-subtitle">Modify details for: <span class="font-semibold text-gray-900 dark:text-white">{{ $category->name }}</span></p>
                </div>
            </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="admin-card">
                            ...
                            <div class="admin-card-body space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" required class="fi">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4" class="fi">{{ old('description', $category->description) }}</textarea>
                        ...
                        <div class="admin-card">
                            ...
                            <div class="admin-card-body">
                                ...
                                <div id="no-banners-msg" class="py-12 text-center border-2 border-dashed border-gray-200 dark:border-surface-tonal-a30 rounded-2xl hidden">
                            ...
                            <div class="admin-card-body space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="aspect-square admin-upload-zone"
                                        ...
                                        <img id="image-preview" src="{{ $category->image_url }}" class="absolute inset-0 w-full h-full object-cover {{ $category->image ? '' : 'hidden' }}">
                                        <div id="image-placeholder" class="admin-upload-placeholder {{ $category->image ? 'hidden' : '' }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <div class="aspect-[16/7] admin-upload-zone"
                                ...
                                <div id="placeholder-${index}" class="admin-upload-placeholder ${data.image_url ? 'hidden' : ''}">
                        ...
                        <div class="md:col-span-3 space-y-4">
                            <div>
                                ...
                                <input type="text" name="banners[${index}][title]" value="${data.title || ''}" placeholder="Catchy headline..." class="fi">
                            </div>
                            <div>
                                <label class="fi-label">Description</label>
                                <textarea name="banners[${index}][description]" rows="2" placeholder="Sub-text highlighting the offer..." class="fi">${data.description || ''}</textarea>
                            </div>
                        </div>
                    </div>
                `;
