        ...
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Provider Modification
                    </h1>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 font-medium">Updating logistics parameters for
                        <span
                ...
                <div>
                    <form action="{{ route('shipping.couriers.destroy', $courier) }}" method="POST"
                        onsubmit="return confirm('Obliterate this provider from the logistics matrix?');">
                        @csrf
                        @method('DELETE')
                        <button type="submit"
                            class="text-[10px] font-black uppercase tracking-widest text-red-500 hover:text-red-600 transition-colors flex items-center gap-2 px-4 py-2 rounded-xl hover:bg-red-50 dark:hover:bg-red-500/5">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-5">
                                <div class="space-y-1.5">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Corporate
                                ...
                                <div class="space-y-1.5">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Operational
                                        Overview</label>
                                    <textarea name="description" rows="4"
                                        placeholder="Define the utility and regional specializations..."
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    class="text-[10px] font-black text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20 uppercase tracking-widest italic">Encrypted
                                    Secure Tunnel</span>
                            </div>
                            <div class="p-6 space-y-6">
                                <div class="space-y-1.5">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Primary
                                        Endpoint URL</label>
                                    <div class="relative flex items-center">
                                        ...
                                        <input type="url" name="base_url" value="{{ old('base_url', $courier->base_url) }}"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div class="space-y-1.5">
                                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Access
                                            Key</label>
                                        <input type="text" name="api_key" value="{{ old('api_key', $courier->api_key) }}"
                                    ...
                                    <div class="space-y-1.5">
                                        <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Secret
                                            Token</label>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-4">
                                ...
                                <label
                                    class="flex items-start p-3 rounded-xl border border-gray-50 dark:border-surface-tonal-a10 hover:bg-gray-50 dark:hover:bg-surface-tonal-a10/40 transition-all cursor-pointer">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-bold text-gray-900 dark:text-white leading-tight">Sync
                                            Tracking</p>
                                        <p class="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">Automated status
                                            updates via API</p>
                                    </div>
                                </label>
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="supports_label_generation" value="1" {{ old('supports_label_generation', $courier->supports_label_generation) ? 'checked' : '' }}
                                        class="mt-1 h-5 w-5 rounded-md border-gray-300 dark:border-surface-tonal-a30 text-indigo-500 focus:ring-indigo-500 transition-all">
                                    <div class="ml-4">
                                        <p class="text-sm font-bold text-gray-900 dark:text-white leading-tight">Waybill
                                            Printing</p>
                                        <p class="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">Generate shipping
                                            labels on demand</p>
                                    </div>
                                </label>
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="supports_cod" value="1" {{ old('supports_cod', $courier->supports_cod) ? 'checked' : '' }}
                                        class="mt-1 h-5 w-5 rounded-md border-gray-300 dark:border-surface-tonal-a30 text-indigo-500 focus:ring-indigo-500 transition-all">
                                    <div class="ml-4">
                                        <p class="text-sm font-bold text-gray-900 dark:text-white leading-tight">Financial
                                            Collection</p>
                                        <p class="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">Supports Cash on
                                            Delivery processing</p>
                                    </div>
                                </label>

                                <label
                                    class="flex items-start p-3 rounded-xl border border-indigo-50 dark:border-indigo-500/10 bg-indigo-50/30 dark:bg-indigo-500/5 hover:bg-indigo-50 dark:hover:bg-indigo-500/10 transition-all cursor-pointer">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-bold text-indigo-900 dark:text-indigo-400 leading-tight">
                                            Primary COD Routing</p>
                                        <p
                                            class="text-[10px] text-indigo-600/60 dark:text-indigo-400/60 mt-0.5 uppercase font-black tracking-tighter">
                                            Automatic assignment priority</p>
                                    </div>
                                </label>

                                <div class="pt-4 mt-2 border-t border-gray-100 dark:border-surface-tonal-a30">
                                    <label
                                        class="flex items-center p-3 rounded-xl hover:bg-emerald-50/50 dark:hover:bg-emerald-500/5 transition-all cursor-pointer group">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <p class="text-[10px] text-gray-500 dark:text-gray-400">Available for logic
                                                routing</p>
                                        </div>
                                    </label>
                                </div>
