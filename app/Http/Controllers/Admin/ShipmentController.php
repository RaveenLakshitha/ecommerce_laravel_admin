    ...
    public function datatable(Request $request)
    {
        ...
        return datatables()->of($query)
            ...
            ->addColumn('actions_html', function ($row) {
                $viewUrl   = route('shipping.shipments.show', $row->id);
                ...
                <div class="flex items-center justify-end gap-2">
                    <a href="' . $viewUrl . '"
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wider
                               bg-teal-50 dark:bg-teal-900/20 text-teal-700 dark:text-teal-400
                               hover:bg-teal-100 dark:hover:bg-teal-900/40 border border-teal-200/60 dark:border-teal-500/20
                    ...
                    <button type="button"
                        ...
                        class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wider
                               ...
                               hover:bg-red-100 dark:hover:bg-red-900/40 border border-red-200/60 dark:border-red-500/20
                               transition-all active:scale-95"
                        title="' . $deleteLabel . '">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            ->rawColumns(['order_id_html', 'courier_html', 'status_html', 'actions_html'])
            ->make(true);
    }
