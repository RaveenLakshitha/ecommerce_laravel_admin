...
@section('title', __('file.add_new_product'))
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div
                            ...
                            <div class="p-4">
                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('file.base_price') }}</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <label
                                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('file.sale_price') }}</label>
                                        <div class="relative">
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                @error('images') <p class="text-xs text-red-500 mt-2 font-medium px-1">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
