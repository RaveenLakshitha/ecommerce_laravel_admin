...
@section('content')
    ...
    <div class="pg-container" style="max-width: 1000px; margin: 80px auto; padding: 20px;">
        <h1
            style="color: var(--white); font-family: var(--font-display); font-size: 3.5rem; margin-bottom: 30px; text-transform: uppercase; letter-spacing: 0.05em;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; align-items: start; margin-bottom: 60px;">
            ...
            @endphp
            <div
                style="position: relative; border-radius: 12px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
                <img src="{{ $ourStoryImg }}" alt="Our Story"
                    style="width: 100%; height: auto; display: block; filter: brightness(0.9);">
            </div>

            <div
                style="color: var(--silver); line-height: 1.8; font-size: 1.15rem; background: var(--bg-2); padding: 40px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05); height: 100%;">
        ...
        <div id="contact-info"
            ...
            <p style="margin-top: 30px; font-style: italic; color: var(--dim);">Please reach out to us with any questions or
                concerns. We will get back to you as soon as possible.</p>
        </div>
    </div>
@endsection