...
@section('title', __('file.edit_collection'))
            ...
            <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        {{ __('file.edit_collection') }}</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ __('file.updating') }}: <span
                            class="font-bold text-gray-900 dark:text-white">{{ $collection->name }}</span></p>
                </div>
                        ...
                        <div
                            ...
                            <div class="p-4 space-y-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        <label for="name"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">{{ __('file.collection_name') }}
                                    ...
                                    <div>
                                        <label for="slug"
                                            class="block text-[10px] font-black text-black dark:text-white uppercase tracking-widest mb-1">{{ __('file.slug') }}
                                            <span class="text-red-500">*</span></label>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                        class="block w-full rounded-md border border-gray-100/50 dark:border-white/5 bg-gray-50/30 dark:bg-surface-tonal-a20 px-3 py-2 text-xs font-bold shadow-sm placeholder:text-gray-400 dark:placeholder:text-gray-300 text-black dark:text-white outline-none transition-all focus:bg-white dark:focus:bg-surface-tonal-a30 resize-y">{{ old('description', $collection->description) }}</textarea>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="aspect-[16/9] admin-upload-zone rounded-xl border-dashed border-2 border-gray-200 dark:border-surface-tonal-a30 bg-gray-100/50 dark:bg-surface-tonal-a30/20 flex flex-col items-center justify-center gap-1 cursor-pointer hover:border-indigo-400 transition-all overflow-hidden relative group"
                                        ...
                                        <div id="banner-placeholder"
                                            class="flex flex-col items-center justify-center gap-1 {{ $collection->banner_url ? 'hidden' : '' }}">
