...
@section('content')
            ...
            <div class="mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                    <a href="{{ route('discount-rules.index') }}"
                        ...
                        Back to Rules</a>
                    <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Edit Discount Rule</h1>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Modify settings for: <span
                            class="text-indigo-600 dark:text-indigo-400 font-bold">{{ $discountRule->name }}</span></p>
                </div>
            </div>
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <textarea name="description" id="description" rows="3"
                                        class="block w-full rounded-xl border-gray-200 dark:border-surface-tonal-a30 bg-white dark:bg-surface-tonal-a30 px-4 py-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all shadow-sm resize-none">{{ old('description', $discountRule->description) }}</textarea>
    ...
    @push('scripts')
        <script>
            ...
            // Initialize existing banners & Restore old from validation failure
