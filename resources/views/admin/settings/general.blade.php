...
@section('content')
    <div class="px-4 sm:px-6 lg:px-4 pb-4 sm:py-12 pt-20">
        <div class=" mb-8">
            <h1 class="text-3xl font-semibold text-gray-900 dark:text-primary-a0">{{ __('file.clinic_settings') }}</h1>
            ...
            <div
                ...
                <div class="p-6 space-y-12">
                    <div class="border-b border-gray-200 dark:border-surface-tonal-a30 pb-6">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-primary-a0 mb-6">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('file.site_name') }}
                                    ...
                                    <input type="text" name="site_name"
                                        ...
                                        placeholder="{{ __('file.site_name_placeholder') }}">
                                    @error('site_name') <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">
                                        {{ $message }}
                                    </p> @enderror
                                </div>
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('file.site_id') }}
                                        <span class="text-red-500">*</span></label>
                                    <input type="text" name="site_id" value="{{ old('site_id', $setting->site_id) }}"
                                        required
                                        class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-primary-a0 transition-shadow"
                                        placeholder="{{ __('file.site_id_placeholder') }}">
                                    @error('site_id') <p class="mt-1.5 text-xs text-red-600 dark:text-red-400">
                                        {{ $message }}
                                    </p> @enderror
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="address" rows="3" required
                                    class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-primary-a0 transition-shadow resize-none"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="currency" maxlength="3"
                                        ...
                                        class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-primary-a0 transition-shadow uppercase font-mono tracking-wider">
                    ...
                    <div>
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('file.site_logo') }}</label>
                                    @if($setting->logo_path)
                                        <div
                                            class="mb-3 p-4 bg-gray-50 dark:bg-surface-tonal-a20 rounded-lg border border-gray-200 dark:border-surface-tonal-a30">
                                    ...
                                    <input type="file" name="logo" accept=".png,.jpg,.jpeg,.svg"
                                        class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-500 focus:border-transparent dark:bg-transparent dark:text-primary-a0 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-medium file:bg-gray-900 file:text-white hover:file:bg-gray-800 dark:file:bg-gray-700 dark:hover:file:bg-gray-600">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <input type="text" value="{{ old('primary_color', $setting->primary_color) }}"
                                            readonly
                                            class="flex-1 px-3 py-2 text-sm font-mono border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-surface-tonal-a20 dark:text-primary-a0">
                                    </div>
                                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
