                    ...
                    <form :action="formUrl" method="POST">
                        ...
                        <div
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white"
                                x-text="isEditing ? 'Edit Shipping Zone' : 'Add Shipping Zone'"></h3>
                        ...
                        <div class="px-6 py-6 space-y-5">
                            <div class="space-y-1">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Zone Name <span
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-1">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Country Code
                                        (ISO) <span class="text-red-500">*</span></label>
                                    <input type="text" name="country_code" x-model="form.country_code" required
                                        maxlength="2" placeholder="LK"
                                ...
                                <div class="space-y-1">
                                    <label
                                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Sub-Region</label>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <label for="is_active"
                                    class="text-sm font-medium text-gray-700 dark:text-gray-300 text-sm">Active Operational
                                    Status</label>
                            </div>
                        </div>
